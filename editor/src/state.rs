...
impl State {
    pub async fn new(window: Arc<Window>) -> eyre::Result<Self> {
        ...
        tracing::info!(
            "Using adapter {} with driver {} ({}) and backend {:?}",
            adapter_info.name,
            adapter_info.driver,
        ...
        tracing::debug!("Using surface format {surface_format:?}");
        ...
        tracing::debug!("Using present mode {present_mode:?}");
        ...
        tracing::trace!("Created render pipeline");
